        ...
        $.div(
          ...
          collect(
            ...
            $.ul(
              {},
              collect(
                $.li({}, $.of("Server-side rendering")),
                $.li({}, $.of("Seamless hydration")),
                $.li({}, $.of("Loaders for data fetching")),
                $.li({}, $.of("Client-side navigation")),
                $.li({}, $.of("Reactive signals")),
              ),
            ),
          ),
        ),
...
const AboutPage = () =>
  $.div(
    ...
    collect(
      ...
      $.p(
        {},
        $.of("This is a sample Effex application with server-side rendering."),
      ),
      $.p(
        {},
        $.of(
          "Effex is built entirely on Effect.ts primitives, providing full type safety and powerful abstractions for building reactive user interfaces.",
        ),
      ),
