...
const Root = <E = never, R = never>(
  ...
  children: ChildEffect<E, R | NavigationMenuCtx>,
  ...
  }) as Element.Element<HTMLElement, E, R>;
...
const List = <E = never, R = never>(
...
): Element.Element<HTMLOListElement, E, R | NavigationMenuCtx> =>
  Effect.gen(function* () {
  ...
  }) as Element.Element<HTMLOListElement, E, R | NavigationMenuCtx>;
...
const Item = <E = never, R = never>(
  ...
  children: ChildEffect<E, R | NavigationMenuItemCtx>,
): Element.Element<HTMLLIElement, E, R | NavigationMenuCtx> =>
  Effect.gen(function* () {
    const ctx = yield* NavigationMenuCtx;
  ...
  }) as Element.Element<HTMLLIElement, E, R | NavigationMenuCtx>;
...
const Trigger = <E = never, R = never>(
  ...
  HTMLButtonElement,
  E,
  R | NavigationMenuCtx | NavigationMenuItemCtx
> =>
  Effect.gen(function* () {
    const ctx = yield* NavigationMenuCtx;
...
): Element.Element<HTMLDivElement, never, NavigationMenuCtx> =>
  Effect.gen(function* () {
    const ctx = yield* NavigationMenuCtx;
