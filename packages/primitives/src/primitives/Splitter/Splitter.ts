...
const Root = <E = never, R = never>(
  ...
  children: ChildEffect<E, R | SplitterCtx>,
...
const Panel = <E = never, R = never>(
  ...
  children: ChildEffect<E, R | SplitterPanelCtx>,
): Element.Element<HTMLDivElement, E, R | SplitterCtx> =>
  Effect.gen(function* () {
  ...
  }) as Element.Element<HTMLDivElement, E, R | SplitterCtx>;
...
): Element.Element<HTMLDivElement, never, SplitterCtx> =>
  Effect.gen(function* () {
    const ctx = yield* SplitterCtx;
