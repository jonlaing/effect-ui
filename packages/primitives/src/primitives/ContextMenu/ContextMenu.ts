...
const Root = <E = never, R = never>(
  ...
  children: ChildEffect<E, R | ContextMenuCtx>,
...
const Trigger = <E = never, R = never>(
...
): Element.Element<HTMLDivElement, E, R | ContextMenuCtx> =>
  Effect.gen(function* () {
  ...
  }) as Element.Element<HTMLDivElement, E, R | ContextMenuCtx>;
...
const RadioGroup = <E = never, R = never>(
  ...
  children: ChildEffect<E, R | ContextMenuRadioGroupCtx>,
): Element.Element<HTMLDivElement, E, R> =>
  Effect.gen(function* () {
...
const RadioItem = <E = never, R = never>(
  ...
  HTMLDivElement,
  E,
  R | ContextMenuCtx | ContextMenuRadioGroupCtx
> =>
  Effect.gen(function* () {
    const ctx = yield* ContextMenuCtx;
...
const Sub = <E = never, R = never>(
  ...
  children: ChildEffect<E, R | ContextMenuSubCtx>,
): Element.Element<HTMLDivElement, E, R> =>
  Effect.gen(function* () {
...
const SubTrigger = <E = never, R = never>(
  ...
  children: ChildEffect<E, R>,
): Element.Element<HTMLDivElement, E, R | ContextMenuSubCtx> =>
  Effect.gen(function* () {
  ...
  }) as Element.Element<HTMLDivElement, E, R | ContextMenuSubCtx>;
...
const SubContent = <E = never, R = never>(
  ...
  children: ChildEffect<E, R>,
): Element.Element<HTMLDivElement, E, R | ContextMenuCtx | ContextMenuSubCtx> =>
  Effect.gen(function* () {
    ...
    HTMLDivElement,
    E,
    R | ContextMenuCtx | ContextMenuSubCtx
  >;
