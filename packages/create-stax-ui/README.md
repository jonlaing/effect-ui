...
Includes:
- `@stax-ui/dom` — DOM rendering and reactivity
- `@stax-ui/router` — Client-side routing
...
Includes:
- `@stax-ui/dom` — DOM rendering and reactivity
- `@stax-ui/router` — Routing (shared between server and client)
- `@stax-ui/platform` — SSR rendering and data loading
- `@stax-ui/vite-plugin` — Dev server with HMR and server-code stripping
...
Includes:
- `@stax-ui/dom` — DOM rendering and reactivity
- `@stax-ui/router` — Routing (shared between build and client)
- `@stax-ui/platform` — Static site generation via `buildStaticSite`
- `@stax-ui/vite-plugin` configured in `ssg` mode — runs the static build after the client bundle
- Client hydration entry point
