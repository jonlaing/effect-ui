...
[@jonlaing/effect-ui](../globals.md) / Tabs

# Variable: Tabs

> `const` **Tabs**: `object`

Defined in: [src/primitives/Tabs/Tabs.ts:355](https://github.com/jonlaing/effect-ui/blob/5c8e6a73fe71d5c320b454ab84a9938a1f710309/src/primitives/Tabs/Tabs.ts#L355)
...
> **Content**: [`Component`](../type-aliases/Component.md)\<`"TabsContent"`, [`TabsContentProps`](../interfaces/TabsContentProps.md), `never`, [`TabsCtx`](../classes/TabsCtx.md)\>
...
> **List**: [`Component`](../type-aliases/Component.md)\<`"TabsList"`, [`TabsListProps`](../interfaces/TabsListProps.md), `never`, [`TabsCtx`](../classes/TabsCtx.md)\>
...
[`Element`](../type-aliases/Element.md)\<`never`, [`TabsCtx`](../classes/TabsCtx.md)\> | [`Element`](../type-aliases/Element.md)\<`never`, [`TabsCtx`](../classes/TabsCtx.md)\>[]
...
> **Trigger**: [`Component`](../type-aliases/Component.md)\<`"TabsTrigger"`, [`TabsTriggerProps`](../interfaces/TabsTriggerProps.md), `never`, [`TabsCtx`](../classes/TabsCtx.md)\>
