...
[@jonlaing/effect-ui](../globals.md) / Popover

# Variable: Popover

> `const` **Popover**: `object`

Defined in: [src/primitives/Popover/Popover.ts:418](https://github.com/jonlaing/effect-ui/blob/5c8e6a73fe71d5c320b454ab84a9938a1f710309/src/primitives/Popover/Popover.ts#L418)
...
> **Anchor**: [`Component`](../type-aliases/Component.md)\<`"PopoverAnchor"`, [`PopoverAnchorProps`](../interfaces/PopoverAnchorProps.md), `never`, [`PopoverCtx`](../classes/PopoverCtx.md)\>
...
> **Close**: [`Component`](../type-aliases/Component.md)\<`"PopoverClose"`, [`PopoverCloseProps`](../interfaces/PopoverCloseProps.md), `never`, [`PopoverCtx`](../classes/PopoverCtx.md)\>
...
> **Content**: [`Component`](../type-aliases/Component.md)\<`"PopoverContent"`, [`PopoverContentProps`](../interfaces/PopoverContentProps.md), `never`, [`PopoverCtx`](../classes/PopoverCtx.md)\>
...
[`Element`](../type-aliases/Element.md)\<`never`, [`PopoverCtx`](../classes/PopoverCtx.md)\> | [`Element`](../type-aliases/Element.md)\<`never`, [`PopoverCtx`](../classes/PopoverCtx.md)\>[]
...
> **Trigger**: [`Component`](../type-aliases/Component.md)\<`"PopoverTrigger"`, [`PopoverTriggerProps`](../interfaces/PopoverTriggerProps.md), `never`, [`PopoverCtx`](../classes/PopoverCtx.md)\>
