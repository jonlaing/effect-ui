...
[@jonlaing/effect-ui](../globals.md) / Slider

# Variable: Slider

> `const` **Slider**: `object`

Defined in: [src/primitives/Slider/Slider.ts:649](https://github.com/jonlaing/effect-ui/blob/5c8e6a73fe71d5c320b454ab84a9938a1f710309/src/primitives/Slider/Slider.ts#L649)
...
> **Range**: [`Component`](../type-aliases/Component.md)\<`"SliderRange"`, [`SliderRangeProps`](../interfaces/SliderRangeProps.md), `never`, [`SliderCtx`](../classes/SliderCtx.md)\>
...
[`Element`](../type-aliases/Element.md)\<`never`, [`SliderCtx`](../classes/SliderCtx.md)\> | [`Element`](../type-aliases/Element.md)\<`never`, [`SliderCtx`](../classes/SliderCtx.md)\>[]
...
> **Thumb**: [`Component`](../type-aliases/Component.md)\<`"SliderThumb"`, [`SliderThumbProps`](../interfaces/SliderThumbProps.md), `never`, [`SliderCtx`](../classes/SliderCtx.md)\>

Draggable thumb handle. Has role="slider" with ARIA attributes.

### Track

> **Track**: [`Component`](../type-aliases/Component.md)\<`"SliderTrack"`, [`SliderTrackProps`](../interfaces/SliderTrackProps.md), `never`, [`SliderCtx`](../classes/SliderCtx.md)\>
