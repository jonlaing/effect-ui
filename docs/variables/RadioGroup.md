...
[@jonlaing/effect-ui](../globals.md) / RadioGroup

# Variable: RadioGroup

> `const` **RadioGroup**: `object`

Defined in: [src/primitives/RadioGroup/RadioGroup.ts:292](https://github.com/jonlaing/effect-ui/blob/5c8e6a73fe71d5c320b454ab84a9938a1f710309/src/primitives/RadioGroup/RadioGroup.ts#L292)
...
> **Item**: [`Component`](../type-aliases/Component.md)\<`"RadioGroupItem"`, [`RadioGroupItemProps`](../interfaces/RadioGroupItemProps.md), `never`, [`RadioGroupCtx`](../classes/RadioGroupCtx.md)\>
...
[`Element`](../type-aliases/Element.md)\<`never`, [`RadioGroupCtx`](../classes/RadioGroupCtx.md)\> | [`Element`](../type-aliases/Element.md)\<`never`, [`RadioGroupCtx`](../classes/RadioGroupCtx.md)\>[]
